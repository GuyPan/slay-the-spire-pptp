...
import pptpinsts.orbs.PptpDetective;
import pptpinsts.util.CardStats;

public class PptpCallDetective extends BaseCard {
    public static final String ID = makeID(PptpCallDetective.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        for(int i = 0; i < this.magicNumber; ++i) {
            AbstractOrb orb = new PptpDetective();
